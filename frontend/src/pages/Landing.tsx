  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <nav className="relative z-10 flex items-center justify-between px-8 py-6 max-w-7xl mx-auto">
        ...
        <Link to="/dashboard">
          <button className="px-6 py-2.5 rounded-full bg-white border border-slate-200 hover:bg-slate-50 transition-all shadow-sm font-medium text-sm flex items-center gap-2 group text-slate-700">
            Launch App
      ...
      <main className="relative z-10 flex flex-col items-center justify-center min-h-[80vh] px-4 text-center max-w-5xl mx-auto mt-10">
        ...
        <div className="flex items-center gap-4">
          ...
          <a href="#features" className="px-8 py-4 rounded-full bg-white hover:bg-slate-50 border border-slate-200 transition-all shadow-sm font-semibold text-lg text-slate-600">
            Learn More
          </a>
        </div>
      </main>
      ...
      {/* Features */}
      <section id="features" className="relative z-10 py-24 px-8 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-slate-900">
        <div className="p-8 rounded-3xl bg-white border border-slate-200 shadow-sm hover:shadow-md transition-all">
          ...
          <p className="text-slate-500">LLM agents analyze market conditions and debate strategies before generating a unified proposal.</p>
        </div>
        <div className="p-8 rounded-3xl bg-white border border-slate-200 shadow-sm hover:shadow-md transition-all">
          ...
          <p className="text-slate-500">All strategy generations and voting logic are executed inside Ritual's TEE, ensuring complete privacy and verifiable execution.</p>
        </div>
        <div className="p-8 rounded-3xl bg-white border border-slate-200 shadow-sm hover:shadow-md transition-all">
          ...
          <p className="text-slate-500">Ritual Scheduler automatically triggers debate, voting, and rebalancing cycles without manual intervention.</p>
        </div>
      </section>
    </div>
  );
